...
cat train_style_metric_model.sh
...
python main.py --audioset_train_paths=/mnt/vdb/audioset-large/train_list.txt --audioset_valid_folder=/mnt/vdb/audioset-large/valid_wav_16k --output_size=1024 --save_every=1 /mnt/vdb/run-style-metric-model-03-07-2024/
